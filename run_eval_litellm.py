...
Examples
    uv run python run_eval_litellm.py --model openai/gpt-5.6-sol          --tag gpt-5.6-sol
    uv run python run_eval_litellm.py --model anthropic/claude-sonnet-5   --tag claude-sonnet-5
    uv run python run_eval_litellm.py --model google/gemini-3.1-pro-global --tag gemini-3.1-pro
